...
@section('content')
    @component('backend._slots.panel')
        ...
        <div class="layui-card-body">
            <button class="layui-btn sp-open-link" url="/{{$controller}}/create" area="750px,500px">新增收款银行卡</button>
        </div>
    @endcomponent
    ...
    @component('backend._slots.panel')
        <div class="layui-card-body">
            <table class="layui-table">
                ...
                <tbody id="sp-loaded-table" loaded="loaded" url="/{{$controller}}/list">@include('backend.cards._list')</tbody>
            </table>
        </div>
    @endcomponent
@endsection