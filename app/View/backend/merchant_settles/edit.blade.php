...
@section('content')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="amount" lay-verify="required" placeholder="请输入应用名称" autocomplete="off"
                   class="layui-input" value="{{$r->amount}}"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">手续费</label>
        <div class="layui-input-inline">
            <input type="text" name="fee" lay-verify="required" placeholder="请输入应用名称" autocomplete="off"
                   class="layui-input" value="{{$r->fee}}"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">实际结算金额</label>
        <div class="layui-input-inline">
            <input type="text" name="amount_settled" lay-verify="required" placeholder="请输入应用名称" autocomplete="off"
                   class="layui-input" value="{{$r->amount_settled}}"/>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="branch_name" lay-verify="required" placeholder="请输入应用名称" autocomplete="off"
                   class="layui-input" value="{{$r->branch_name}}"/>
            </select>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="real_name" lay-verify="required" placeholder="请输入应用名称" autocomplete="off"
                   class="layui-input" value="{{$r->real_name}}"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">银行卡号</label>
        <div class="layui-input-inline">
            <input type="text" name="card_number" lay-verify="required" placeholder="请输入应用名称" autocomplete="off"
                   class="layui-input" value="{{$r->card_number}}"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">手机号</label>
        <div class="layui-input-inline">
            <input type="text" name="phone" lay-verify="required" placeholder="请输入应用名称" autocomplete="off"
                   class="layui-input" value="{{$r->phone}}"/>
        </div>
    </div>
    <div class="layui-form-item">
