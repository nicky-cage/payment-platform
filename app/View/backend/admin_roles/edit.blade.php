...
@section('content')
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="name" lay-verify="required" placeholder="请输入角色名称" autocomplete="off"
                   class="layui-input" value="{{$r->name}}" style="width: 380px;"/>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="remark" lay-verify="required" placeholder="请输入备注" autocomplete="off"
                   class="layui-input" value="{{$r->remark}}" style="width: 380px;"/>
        </div>
    </div>
    <script>
        layui.use([ 'jquery', 'layer', 'tree'], function () {
            let $ = layui.jquery,
                ...
                tree = layui.tree;
            $(function () {
                $.post("/admin_roles/all", {"id": $("#id").val()}, function (res) {
                    tree.render({
                        elem: '#AdminRole'
                        , data: res.data
