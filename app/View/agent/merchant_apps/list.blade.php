...
<div class="layui-card-body">
    <button class="layui-btn sp-open-link" url="/{{$controller}}/create" area="750px,650px">新增应用</button>
</div>
@endcomponent
...
<div class="layui-card-body">
    <table class="layui-table">
        ...
        <tbody id="sp-loaded-table" loaded="loaded" url="/{{$controller}}/list">@include('agent.merchant_apps._list')</tbody>
    </table>
</div>
<script>
